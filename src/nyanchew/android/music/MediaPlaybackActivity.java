...
import nyanchew.android.music.MusicUtils.ServiceToken;
import nyanchew.android.music.RepeatingImageButton.RepeatListener;
    ...
    View.OnTouchListener, View.OnLongClickListener, OnGesturePerformedListener
{
    ...
    private View.OnClickListener mQueueListener = new View.OnClickListener() {
        public void onClick(View v) {
            startActivity(
                    ...
                    .setPackage("nyanchew.android.music")
    ...
    private RepeatListener mRewListener =
    ...
    private RepeatListener mFfwdListener =
        new RepeatingImageButton.RepeatListener() {
        public void onRepeat(View v, long howlong, int repcnt) {
    ...
    public void onStart() {
        ...
        f.addAction(NycwMediaPlaybackService.PLAYSTATE_CHANGED);
        f.addAction(NycwMediaPlaybackService.META_CHANGED);
        f.addAction(NycwMediaPlaybackService.PLAYBACK_COMPLETE);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (item != null) {
            ...
            if (shuffle == NycwMediaPlaybackService.SHUFFLE_AUTO) {
...
*/
    ...
    private void toggleShuffle() {
        ...
        try {
            ...
            if (shuffle == NycwMediaPlaybackService.SHUFFLE_NONE) {
                mService.setShuffleMode(NycwMediaPlaybackService.SHUFFLE_NORMAL);
                if (mService.getRepeatMode() == NycwMediaPlaybackService.REPEAT_CURRENT) {
                    mService.setRepeatMode(NycwMediaPlaybackService.REPEAT_ALL);
                    setRepeatButtonImage();
                }
                showToast(R.string.shuffle_on_notif);
            } else if (shuffle == NycwMediaPlaybackService.SHUFFLE_NORMAL ||
                    shuffle == NycwMediaPlaybackService.SHUFFLE_AUTO) {
                mService.setShuffleMode(NycwMediaPlaybackService.SHUFFLE_NONE);
    ...
    private void cycleRepeat() {
        ...
        try {
            ...
            if (mode == NycwMediaPlaybackService.REPEAT_NONE) {
                mService.setRepeatMode(NycwMediaPlaybackService.REPEAT_ALL);
                showToast(R.string.repeat_all_notif);
            } else if (mode == NycwMediaPlaybackService.REPEAT_ALL) {
                mService.setRepeatMode(NycwMediaPlaybackService.REPEAT_CURRENT);
                if (mService.getShuffleMode() != NycwMediaPlaybackService.SHUFFLE_NONE) {
                    mService.setShuffleMode(NycwMediaPlaybackService.SHUFFLE_NONE);
                    setShuffleButtonImage();
                }
                showToast(R.string.repeat_current_notif);
            } else {
                mService.setRepeatMode(NycwMediaPlaybackService.REPEAT_NONE);
    ...
    private void setRepeatButtonImage() {
        ...
        try {
            switch (mService.getRepeatMode()) {
                case NycwMediaPlaybackService.REPEAT_ALL:
                    mRepeatButton.setImageResource(R.drawable.ic_mp_repeat_all_btn);
                    break;
                case NycwMediaPlaybackService.REPEAT_CURRENT:
    ...
    private void setShuffleButtonImage() {
        ...
        try {
            switch (mService.getShuffleMode()) {
                case NycwMediaPlaybackService.SHUFFLE_NONE:
                    mShuffleButton.setImageResource(R.drawable.ic_mp_shuffle_off_btn);
                    break;
                case NycwMediaPlaybackService.SHUFFLE_AUTO:
    ...
    private BroadcastReceiver mStatusListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(NycwMediaPlaybackService.META_CHANGED)) {
                // redraw the artist/title info and
                // set new max for progress bar
                updateTrackInfo();
                setPauseButtonImage();
                queueNextRefresh(1);
            } else if (action.equals(NycwMediaPlaybackService.PLAYBACK_COMPLETE)) {
                if (mOneShot) {
                    finish();
                } else {
                    setPauseButtonImage();
                }
            } else if (action.equals(NycwMediaPlaybackService.PLAYSTATE_CHANGED)) {
                setPauseButtonImage();
        ...
        public void onReceive(Context context, Intent intent) {
            if (Intent.ACTION_SCREEN_ON.equals(intent.getAction())) {
                if (mIntentDeRegistered) {
                    ...
                    f.addAction(NycwMediaPlaybackService.META_CHANGED);
                    f.addAction(NycwMediaPlaybackService.PLAYBACK_COMPLETE);
                    f.addAction(NycwMediaPlaybackService.REFRESH_PROGRESSBAR);
