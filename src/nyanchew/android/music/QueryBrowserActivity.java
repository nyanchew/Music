    ...
    */
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        if (Intent.ACTION_VIEW.equals(action)) {
            ...
            if (path.startsWith("content://media/external/audio/media/")) {
                ...
                i.setClass(this, nyanchew.android.music.TrackBrowserActivity.class);
                ...
                i.setClass(this, nyanchew.android.music.AlbumBrowserActivity.class);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        if ("artist".equals(selectedType)) {
            ...
            intent.setClass(this, nyanchew.android.music.AlbumBrowserActivity.class);
            ...
            intent.setClass(this, nyanchew.android.music.TrackBrowserActivity.class);
