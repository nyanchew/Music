...
public class StreamStarter extends Activity
{
        ...
        mToken = MusicUtils.bindToService(this, new ServiceConnection() {
            public void onServiceConnected(ComponentName classname, IBinder obj) {
                try {
                    ...
                    f.addAction(NycwMediaPlaybackService.ASYNC_OPEN_COMPLETE);
    ...
    private BroadcastReceiver mStatusListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(NycwMediaPlaybackService.PLAYBACK_COMPLETE)) {
            ...
            try {
                ...
                intent = new Intent("nyanchew.android.music.PLAYBACK_VIEWER");
