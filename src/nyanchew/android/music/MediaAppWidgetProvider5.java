 ...
 */
public class MediaAppWidgetProvider5 extends AppWidgetProvider {
    static final String TAG = "MusicAppWidgetProvider5";
    
    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate5";
    
    static final ComponentName THIS_APPWIDGET =
        new ComponentName("nyanchew.android.music",
                "nyanchew.android.music.MediaAppWidgetProvider5");
    
    private static MediaAppWidgetProvider5 sInstance;
    
    static synchronized MediaAppWidgetProvider5 getInstance() {
        if (sInstance == null) {
            sInstance = new MediaAppWidgetProvider5();
        }
        return sInstance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        // Send broadcast intent to any running NycwMediaPlaybackService so it can
        ...
        updateIntent.putExtra(NycwMediaPlaybackService.CMDNAME,
                MediaAppWidgetProvider5.CMDAPPWIDGETUPDATE);
    ...
    private void defaultAppWidget(Context context, int[] appWidgetIds) {
        ...
        final RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.album_appwidget4x3);
    ...
    /**
     * Handle a change notification coming over from {@link NycwMediaPlaybackService}
     */
