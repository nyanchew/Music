 ...
 */
public class NycwMediaPlaybackService extends Service {
    ...
    public static final String SCROBBLEDROID = "net.jjc1138.android.scrobbler.action.MUSIC_STATUS";
    public static final int SCROBBLE_PLAY = 0;
    public static final int SCROBBLE_PAUSE = 1;
    ...
    public static final String PROGRESSBAR_CHANGED = "com.android.music.progressbarchanged";
    
    public static final String REFRESH_PROGRESSBAR = "nyanchew.android.music.refreshui";

    public static final String SERVICECMD = "nyanchew.android.music.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "nyanchew.android.music.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "nyanchew.android.music.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "nyanchew.android.music.musicservicecommand.previous";
    public static final String NEXT_ACTION = "nyanchew.android.music.musicservicecommand.next";
    public static final String SHUFFLE_ACTION = "nyanchew.android.music.musicservicecommand.shuffle";
    public static final String REPEAT_ACTION = "nyanchew.android.music.musicservicecommand.repeat";
            ...
            switch (msg.what) {
                ...
                case TRACK_ENDED:
                    if (mRepeatMode == REPEAT_CURRENT) {
                        ...
                        notifyScrobbleDroid(SCROBBLE_PAUSE);
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
		...
		cycleRepeat();
                ...
                mAppWidgetProvider.performUpdate(NycwMediaPlaybackService.this, appWidgetIds);
		Log.d("MediaAppWidgetProvider1", "MediaAppWidgetProvider1 is recieving");
                ...
                // because they were just added.
                int[] appWidgetIds = intent.getIntArrayExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS);
                mAppWidgetProvider2.performUpdate(NycwMediaPlaybackService.this, appWidgetIds);
		Log.d("MediaAppWidgetProvider2", "MediaAppWidgetProvider2 is recieving");
                ...
                // because they were just added.
                int[] appWidgetIds = intent.getIntArrayExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS);
                mAppWidgetProvider3.performUpdate(NycwMediaPlaybackService.this, appWidgetIds);
		Log.d("MediaAppWidgetProvider3", "MediaAppWidgetProvider3 is recieving");
                ...
                // because they were just added.
                int[] appWidgetIds = intent.getIntArrayExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS);
                mAppWidgetProvider4.performUpdate(NycwMediaPlaybackService.this, appWidgetIds);
		Log.d("MediaAppWidgetProvider4", "MediaAppWidgetProvider4 is recieving");
                ...
                // because they were just added.
                int[] appWidgetIds = intent.getIntArrayExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS);
                mAppWidgetProvider5.performUpdate(NycwMediaPlaybackService.this, appWidgetIds);
    ...
    public NycwMediaPlaybackService() {
    }
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        mMediaMountedCount++;
                        mCardId = MusicUtils.getCardId(NycwMediaPlaybackService.this);
                        reloadQueue();
                        notifyChange(QUEUE_CHANGED);
                        notifyChange(META_CHANGED);
                    }
     ...
     * "nyanchew.android.music.metachanged"
     * "nyanchew.android.music.queuechanged",
     * "nyanchew.android.music.playbackcomplete"
     * "nyanchew.android.music.playstatechanged"
    ...
    private void notifyScrobbleDroid(int stat) {
    	Intent i = new Intent(SCROBBLEDROID);
    	switch (stat) {
    	case SCROBBLE_PLAY:
    		i.putExtra("playing", true);
    		//i.putExtra("id", mPlayList[mPlayPos]);
    		i.putExtra("artist", getArtistName());
    		i.putExtra("track", getTrackName());
    		i.putExtra("secs", duration());
    		i.putExtra("album", getAlbumName());
    		break;
    	case SCROBBLE_PAUSE:
    	...
    	sendBroadcast(i);
    	Log.d(LOGTAG, "Broadcast intent: "+String.valueOf(stat)+String.valueOf(mPlayList[mPlayPos]));
    }
    ...
    public void play() {
        ...
        if (mPlayer.isInitialized()) {
            ...
            status.contentIntent = PendingIntent.getActivity(this, 0,
                    new Intent("nyanchew.android.music.PLAYBACK_VIEWER")
                    .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK), 0);
            startForeground(PLAYBACKSERVICE_STATUS, status);
            notifyScrobbleDroid(SCROBBLE_PLAY);
            if (!mIsSupposedToBePlaying) {
    ...
    private class MultiPlayer {
        ...
        public MultiPlayer() {
            mMediaPlayer.setWakeMode(NycwMediaPlaybackService.this, PowerManager.PARTIAL_WAKE_LOCK);
        }
        ...
        public void setDataSource(String path) {
            try {
                ...
                if (path.startsWith("content://")) {
                    mMediaPlayer.setDataSource(NycwMediaPlaybackService.this, Uri.parse(path));
                } else {
                    mMediaPlayer.setDataSource(path);
                }
                mMediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
        ...
        MediaPlayer.OnErrorListener errorListener = new MediaPlayer.OnErrorListener() {
            public boolean onError(MediaPlayer mp, int what, int extra) {
                ...
                default:
                    ...
                    mMediaPlayer.release();
                    mMediaPlayer = new MediaPlayer();
                    Toast.makeText(NycwMediaPlaybackService.this, R.string.playback_failed, Toast.LENGTH_SHORT).show();
                    next(false);
                    break;
                }
                return false;
    ...
    static class ServiceStub extends IMediaPlaybackService.Stub {
        WeakReference<NycwMediaPlaybackService> mService;
        
        ServiceStub(NycwMediaPlaybackService service) {
            mService = new WeakReference<NycwMediaPlaybackService>(service);
        }
